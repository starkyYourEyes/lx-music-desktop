declare namespace LX {
  namespace DesktopLyric {
    interface Config {
      ...
      'desktopLyric.style.extendedLineGap': LX.AppSetting['desktopLyric.style.extendedLineGap']
      'desktopLyric.style.lineHeight': LX.AppSetting['desktopLyric.style.lineHeight']
      'desktopLyric.style.paddingTop': LX.AppSetting['desktopLyric.style.paddingTop']
      'desktopLyric.style.paddingBottom': LX.AppSetting['desktopLyric.style.paddingBottom']
