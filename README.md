...
<h1 align="center">LX Music 修改版</h1>

## 相关

*lx-music桌面版：https://github.com/lyswhut/lx-music-desktop*

*lx-music移动版：https://github.com/lyswhut/lx-music-mobile*
...
### 已完成
- 支持WebDAV，可在设置——其他 输入WebDAV配置，即可在我的云盘展示云盘中的音乐，支持多端同步。
- 新增推荐/私人雷达，登录之后可以自动根据个人更新推荐界面。
- 将 WY 歌曲添加到“我的收藏”时，会同步到 WY “我喜欢的音乐”。
...
见[数据同步服务](https://github.com/lyswhut/lx-music-sync-server#readme)。


## 用户界面

推荐界面  
<p><img width="100%" src="./doc/images/recommendation.png" alt="lx-music desktop UI"></p>  

我的列表界面  
<p><img width="100%" src="./doc/images/my_list.png" alt="lx-music desktop UI"></p>
